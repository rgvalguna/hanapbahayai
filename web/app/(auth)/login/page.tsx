  ...
  return (
    <div className="rounded-2xl border border-[--color-border] bg-white px-8 py-10 shadow-[--shadow-card]">
      ...
      <p className="mb-8 text-sm text-gray-500">
        ...
        <Link href="/register" className="font-medium text-[--color-brand-600] hover:underline">
          Sign up
        </Link>
      </p>
      ...
      <form onSubmit={(e) => void handleSubmit(e)} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-[--color-border] px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-[--color-brand-500] focus:outline-none focus:ring-2 focus:ring-[--color-brand-500]/20"
        ...
        <div>
          ...
          <div className="mt-1 flex justify-end">
            <Link
              ...
              className="text-xs text-gray-500 hover:text-[--color-brand-600]"
            >
              Forgot password?
            </Link>
          </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-4">
          <a
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-[--color-border] bg-white py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50"
          >
